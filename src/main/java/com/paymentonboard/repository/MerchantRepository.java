...
import com.paymentonboard.dto.MerchantList;
...
//	@Query(value = "call pro_MerchantList(:fromDate, :toDate, :merchantId, :merchantName);", nativeQuery = true)
	@Query(value = "call pro_MerchantListV2(:fromDate, :toDate, :merchantId, :resellerId, :merchantName, :norecord, :pageno, :tradeName, :partnerType);", nativeQuery = true)
	List<Object[]> findByMerchantsByDateNameId(String fromDate, String toDate, String merchantId, String resellerId, String merchantName , int norecord, int pageno,String tradeName,String partnerType);
	...
	@Query(value = "call pro_MerchantCreation(:contactPerson, :contactNumber, :emailId, :companypan, :merchantname, :businessname, :businesstype, :DateofIncroporation, :merchantcatagorycode, :merchantsubcatagory, :businessmodal,"
			...
			":merchantType, :parentMerchantId, :resellerType, :merchantBankName, :merchantGroupId, :parentMerchantFlag, :businessAddress, :gstStatus, :isSameBusinessAddress);", nativeQuery = true)
	List<Object[]> createMerchantByNameEmail(String contactPerson, String contactNumber, String emailId,
											 ...
											 String iResellerId, Character iIsCompanyPanVerify, Character iIsGSTVerify,
											 String iCompanyPanVerifyName, String iGSTVerifyName, String name_as_perpan, String Source, String merReturnUrl ,
											 String additional_contact, String sales_lead, String logoPath, String partners_type, String bank_id, String whitelistPath, String logoPathWhitelbeltype,
											 Boolean isplit_settlement, String merchantType, String parentMerchantId, String resellerType,
											 String merchantBankName, String merchantGroupId, boolean parentMerchantFlag, String businessAddress, String gstStatus, boolean isSameBusinessAddress);// 28 values + 1 more as requirement
	...
	@Query(value = "call pro_MerchantBasicSetup(:MerchantId, :isAutoRefund, :hours, :minutes, :isPushUrl, :pushUrl, :settlementCycle,"
			...
			+ " :integrationType, :isretryAllowed, :bpsEmailNotification, :bpsSmsNotification, :bpsMailReminder, :reportingcycle, :upi_loader, :upi_intent, :upi_collect, :static_QR, :dynamic_QR, :pay_page_timer);", nativeQuery = true)

		List<Object[]> cBasicSetupByMerchantId(String MerchantId, String isAutoRefund, String hours, String minutes, String isPushUrl,
				...
				String integrationType, String isretryAllowed, String bpsEmailNotification, String bpsSmsNotification, String bpsMailReminder, String reportingcycle, String upi_loader, String upi_intent, String upi_collect,String static_QR,String dynamic_QR, String pay_page_timer);//24 value
		...
		@Query(value = "INSERT INTO tbl_mstmerchant\r\n"
				...
				+ "created_on,\r\n"
				+ "max_token_size,\r\n"
				+ "merchant_type\r\n) values (:merchantId, :fullName, :emailId, :contactNo, :status, :strDate, :token, 'DIRECT_DVP_MERCHANT')", nativeQuery = true)
		...
		@Transactional
		@Modifying
		@Query(value = "delete from tbl_instrumentactivationstatus where Id=:Id", nativeQuery = true)
		void deleteInstrumentList(String Id);
		...
		@Query(value = "SELECT InstrumentDescription FROM tbl_mstpayment_instruments where InstrumentId=:instrumentId ;", nativeQuery = true)
		String findInstrumentName(String instrumentId);
		...
		List<Map<String, Object>> refundAmtList(String merchantId, String fromDate, String toDate, String id, String bankId,
		...
		@Query(value = "SELECT txn_id FROM tbl_transactionmaster where Id= :txnId", nativeQuery = true)
		String findtransctionBytxnId(String txnId);
		...
		// @Query(value = "SELECT Id FROM tbl_transactionmaster where txn_Id=:transId and merchant_id=:merchant_Id ;", nativeQuery = true)
		...
		@Query(value = "SELECT process_id FROM tbl_transactionmaster where txn_Id=:transId ;", nativeQuery = true)
		String fintransctionProcessId(String transId);
		
		@Query(value = "select serviceProvider.refund_processor from tbl_mstserviceprovider as serviceProvider where sp_id =:processId and isRefundAPI = 'Y'", nativeQuery = true)
		String finRefundProcessor(String processId);
      ...
      @Query(value = "SELECT merchant_id FROM tbl_transactionmaster where txn_Id=:transId ;", nativeQuery = true)
		...
		List<MerchantList> getByIsDeletedAndResellerId(String isDeleted, String resellerId);
		
		@Query("FROM MerchantList WHERE isDeleted=:isDeleted AND (merchantId like %:merchantId% OR merchantName like %:merchantId%)")
		List<MerchantList> getByIsDeletedAndMerchantIdLike(String isDeleted, String merchantId);


		List<MerchantList> findByStatus(String status);

		@Query(value = "select Id  from tbl_mstbusinesstype where BusinessType=:businessType ;", nativeQuery = true)
		String getbussinestypeId(String businessType);

		@Query(value = "select BusinessType  from tbl_mstbusinesstype where Id =:businesstype_Id ;", nativeQuery = true)
		String getbussinestypevalue(String businesstype_Id);

		@Query(value = "Select category_id from tbl_merchant_category where business_desc=:merchant_category_code ;", nativeQuery = true)
		String getmerchant_category_codeId(String merchant_category_code);

		@Query(value = "select SubCatId from tbl_merchant_subcategory where CategoryId=:merchant_category_code1 and SubCategory=:merchant_sub_category ;", nativeQuery = true)
		String getmerchant_sub_categoryId(String merchant_sub_category, String merchant_category_code1);

		@Transactional
		@Modifying
		@Query(value="Update tbl_merchantbulkuploadcsv set merchantid=:merchantId where Id=:Id1 ;", nativeQuery = true)
		void updatemerchantId(String merchantId, int Id1);
		
		@Query(value = "select MerchantId FROM tbl_mstmerchant where reseller_id =:resellerId", nativeQuery = true)
		List<String> getMerchantIdListByResellerId(String resellerId);

		List<MerchantList> findByMerchantTypeAndIsDeleted(MerchantType merchantType, String isDeleted);

	MerchantList findByMerchantIdAndIsDeleted(String merchantId, String isDeleted);

	List<MerchantList> findByMerchantTypeAndResellerIdAndIsDeleted(MerchantType merchantType, String resellerId, String isDeleted);
	...
	@Query(value = "from MerchantList where merchantGroupMst = :groupId and status != :status")
	List<MerchantList> findByMerchantGroupMstAndStatusNot(@Param("groupId") Long groupId, @Param("status") String status);
	
	@Query(value = "Select bankName from tbl_mstpgbank where bankId=:bankId and sp_id = :processId  ;", nativeQuery = true)
	String findBankNameWithProcessId(@Param("bankId") String bankId, @Param("processId") String processId);

	@Transactional
	@Modifying
	@Query(value = "UPDATE tbl_selfonboard set verified = :verfication where otp_num_email= :otp", nativeQuery = true)
	void updateOTPverifiedByEmail(@Param ("otp") String otp, @Param ("verfication") String verfication);

	@Query(value = "select shortname from tbl_reseller_personal_details where reseller_id= :validuserId", nativeQuery = true)
	String findShortNameByRId(String validuserId);

	@Query(value = "select reseller_id from tbl_mstmerchant where MerchantId= :validuserId", nativeQuery = true)
	String findResellerIdByMId(String validuserId);
